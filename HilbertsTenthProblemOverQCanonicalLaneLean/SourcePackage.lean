/-!
# Source package model for `hilberts-tenth-problem-over-q-canonical-lane`
...
def sourceCheckoutHead : String := "d5c978da2ad43f65d94d233c2cc1d280d6ee9ed9"
...
def sourceFiles : List SourceFile := [
  ...
  { path := "scripts/h10q_closure_guard.py", sha256 := "6698673510ae350c05c6632cf5919867c7f55ed6ff245b58b8a114ebff61b16a", functionCount := 9, classCount := 0, assignmentCount := 8, parseOk := true },
...
def sourceFunctions : List SourceFunctionDecl := [
  ...
  { file := "scripts/h10q_closure_guard.py", name := "_finite", args := ["v"], returns := "bool", doc := "", line := 31, isAsync := false },
  { file := "scripts/h10q_closure_guard.py", name := "_resolve", args := ["path_str"], returns := "Path", doc := "", line := 35, isAsync := false },
  { file := "scripts/h10q_closure_guard.py", name := "_bootstrap_registry", args := ["path"], returns := "None", doc := "", line := 42, isAsync := false },
  { file := "scripts/h10q_closure_guard.py", name := "_load_registry", args := ["path"], returns := "dict[str, Any]", doc := "", line := 48, isAsync := false },
  { file := "scripts/h10q_closure_guard.py", name := "_load_sigma_from_stitch", args := ["path"], returns := "float | None", doc := "", line := 60, isAsync := false },
  { file := "scripts/h10q_closure_guard.py", name := "_entry", args := ["constants", "key"], returns := "tuple[float | None, bool]", doc := "", line := 77, isAsync := false },
  { file := "scripts/h10q_closure_guard.py", name := "compute_report", args := ["data", "sigma_star", "strict_coh_zero"], returns := "dict[str, Any]", doc := "", line := 88, isAsync := false },
  { file := "scripts/h10q_closure_guard.py", name := "append_history", args := ["path", "report"], returns := "None", doc := "", line := 121, isAsync := false },
  { file := "scripts/h10q_closure_guard.py", name := "main", args := [], returns := "None", doc := "", line := 128, isAsync := false },
...
def sourceAssignments : List SourceAssignmentDecl := [
  ...
  { file := "scripts/h10q_closure_guard.py", name := "SCRIPT_DIR", value := "Path(__file__).resolve().parent", line := 13 },
  { file := "scripts/h10q_closure_guard.py", name := "PROJECT_ROOT", value := "SCRIPT_DIR.parent", line := 14 },
  { file := "scripts/h10q_closure_guard.py", name := "DEFAULT_REGISTRY", value := "\"artifacts/constants_registry.json\"", line := 16 },
  { file := "scripts/h10q_closure_guard.py", name := "DEFAULT_STITCH", value := "\"artifacts/stitch_constants.json\"", line := 17 },
  { file := "scripts/h10q_closure_guard.py", name := "DEFAULT_OUT", value := "\"repro/certificate_runtime.json\"", line := 18 },
  { file := "scripts/h10q_closure_guard.py", name := "DEFAULT_HISTORY", value := "\"repro/drift_guard_runs.jsonl\"", line := 19 },
  { file := "scripts/h10q_closure_guard.py", name := "PRIMARY_KEYS", value := "[\"kappa_definability\", \"sigma_encoding\", \"kappa_compact\", \"rho_rigidity\", \"undecidability_transfer\"]", line := 21 },
  { file := "scripts/h10q_closure_guard.py", name := "COHERENCE_KEY", value := "\"eps_coh\"", line := 28 },
...
def constantSpecs : List ConstantSpec := [
  { group := "constants", key := "kappa_definability", status := "derived_numeric", formula := "c_def_raw * definability_density_raw - e_def_raw", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Section 4.5 / Appendix A", validation := "required_positive", componentKeys := ["c_def_raw", "definability_density_raw", "e_def_raw"] },
  { group := "constants", key := "sigma_encoding", status := "derived_numeric", formula := "encoding_floor_raw - simulation_loss_raw - restart_loss_raw", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Section 5.2 / Appendix B", validation := "required_positive", componentKeys := ["encoding_floor_raw", "restart_loss_raw", "simulation_loss_raw"] },
  { group := "constants", key := "kappa_compact", status := "derived_numeric", formula := "1.0 / (1.0 + delta_comp_sup_raw)", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Section 5.3 / Appendix C", validation := "required_positive", componentKeys := ["delta_comp_sup_raw"] },
  { group := "constants", key := "rho_rigidity", status := "derived_numeric", formula := "rho_rigidity_raw", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Section 6.1 / Appendix D", validation := "required_positive", componentKeys := ["rho_rigidity_raw"] },
  { group := "constants", key := "undecidability_transfer", status := "derived_numeric", formula := "c_undec_raw * transfer_gain_raw - e_undec_raw", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Section 6.2 / Appendix E.4", validation := "required_positive", componentKeys := ["c_undec_raw", "e_undec_raw", "transfer_gain_raw"] },
  { group := "constants", key := "eps_coh", status := "derived_numeric", formula := "eps_coh_raw", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Appendix E.6", validation := "required_nonnegative", componentKeys := ["eps_coh_raw"] },
  { group := "stitch", key := "sigma_star_can", status := "derived_numeric", formula := "sigma_star_can_raw", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Section 5 / stitch constants", validation := "required_positive", componentKeys := ["sigma_star_can_raw"] }
]

def registryConstants : List RegistryConstant := [
  { key := "eps_coh", value := "0.0", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#eps_coh", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Appendix E.6" },
  { key := "kappa_compact", value := "0.8051529790660226", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_compact", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Section 5.3 / Appendix C" },
  { key := "kappa_definability", value := "1.09441", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#kappa_definability", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Section 4.5 / Appendix A" },
  { key := "rho_rigidity", value := "1.075", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#rho_rigidity", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Section 6.1 / Appendix D" },
  { key := "sigma_encoding", value := "1.072", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#sigma_encoding", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Section 5.2 / Appendix B" },
  { key := "undecidability_transfer", value := "1.0293929999999998", theoremLevel := true, status := "derived_numeric", source := "artifacts/constants_extracted.json#undecidability_transfer", sourceSection := "paper/HILBERTS_TENTH_PROBLEM_OVER_Q_PREPRINT.md Section 6.2 / Appendix E.4" }
]
