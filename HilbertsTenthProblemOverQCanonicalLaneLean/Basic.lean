/-!
# hilberts-tenth-problem-over-q-canonical-lane Lean migration boundary
...
`HilbertsTenthProblemOverQCanonicalLaneLean/SourcePackage.lean`.
...
def sourceRepository : String := "hilberts-tenth-problem-over-q-canonical-lane"
def sourceUrl : String := "https://github.com/HautevilleHouse/hilberts-tenth-problem-over-q-canonical-lane"
def sourceDescription : String := "Canonical-lane closure package for Hilbert's Tenth Problem over Q: admissible-class formulation, projection gates, local-to-global bridge, and carried remainder."
def sourceClassification : String := "abstract_math_theorem_repo"
def sourceTopics : List String := ["decidability", "mathematical-logic", "mathematical-proof", "number-theory", "reproducibility", "diophantine-definability", "hilberts-tenth-problem", "canonical-lane", "local-to-global", "manifold-constrained"]
